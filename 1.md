...
| Test  | Pulsador externo   | Asegura que el reset no es accidental.|
...
| Acelerador de Tiempo (Acel)   | Pulsador externo  | RAcelerador de Tiempo (Acel): Al presionarse le permite al usuario aumentar el tiempo en el que transcurren los eventos del tamagotchi en un determinado factor (x2,x4,x8,x16). |
